...
describe("Testeando la clase idioma.js", () => {
  ...
  describe("Testeando el método mostrarExpresiones()", () => {
    ...
    test("Comprobando que funciona correctamente", () => {
      ...
      var expresion2 = "IL NE FAUT PAS POUSSER MÉMÉ DANS LES ORTIES." + "-" +"LITERALMENTE SIGNIFICA QUE NO DEBEMOS TIRAR A LA ABUELA A LAS ORTIGAS, Y SE USA PARA DECIR QUE NO DEBEMOS EXAGERAR. SU SIGNIFICADO SE DEBE A QUE NUNCA DEBERÍAMOS TIRAR A NUESTRA ABUELA A LAS ORTIGAS, Y SI LO HACEMOS SERÁ UNA EXAGERACIÓN.";
      var vectorEsperado = [];
